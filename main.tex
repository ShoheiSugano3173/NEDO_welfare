...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
\jtitle{課題解決型福祉用具実用化開発支援事業}{}
\etitle{尿便検知可能・排泄センサーの装置一体化の開発}{}

\nendo{2019}

\thesistype{報告書}
\belongdept{独立行政法人新エネルギー・産業技術総合開発機構}
\belongcourse{~}

\ebelongdept{（委託先）株式会社ａｂａ}
\ebelongcourse{~}

\authora{第１８１００９４１－０号}{}{}
%
\datestamp{2019}{3}
%
\headshorttitle{尿便検知可能・排泄センサーの装置一体化の開発}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 絶対に読み込まなければならないスタイル
%  順番を他の位置にしないほうが良い．
